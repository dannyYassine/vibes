...
- **Dates are `Date` objects, not strings.** The Gateway/Service handle the parsing.
...
- The class identity makes it impossible to accidentally pass an API model where an Entity is expected
